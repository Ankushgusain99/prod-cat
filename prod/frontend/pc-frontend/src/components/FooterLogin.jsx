    ...
    <footer className="footer">
      <div className="footer__container">
        ...
        <div className="footer__links">
          <a href="https://www.infyair.in/" className="footer__link">
            Home
          </a>
          <a href="https://www.infyair.in/about" className="footer__link">
            About
          </a>
          <a href="https://www.infyair.in/services" className="footer__link">
            Services
          </a>
          <a href="https://www.infyair.in/technology" className="footer__link">
            Technology
          </a>
          <a href="https://www.infyair.in/projects" className="footer__link">
            Projects
          </a>
          <a href="https://www.infyair.in/careers" className="footer__link">
            Careers
          </a>
          <a href="https://www.infyair.in/contact" className="footer__link">
            Contact
          </a>
        </div>
