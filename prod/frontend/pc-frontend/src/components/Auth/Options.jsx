...
export default function LeftDrawer() {
  ...
  const list = () => (
    ...
    >
      <List
        sx={{ backgroundColor: "#1A1A1A", color: "white", paddingLeft: "65px" }}
      >
        ...
        <ListItem disablePadding sx={{ height: "345px" }}></ListItem>
      </List>
    </Box>
  );
  ...
  return (
    <div>
      ...
      <Drawer anchor="left" open={open} onClose={toggleDrawer(false)}>
        <div
          style={{ display: "flex", backgroundColor: "#333", padding: "10px" }}
        >
          <AccountCircleOutlinedIcon
            sx={{ color: "white", fontSize: "60px", marginLeft: "10px" }}
          />
