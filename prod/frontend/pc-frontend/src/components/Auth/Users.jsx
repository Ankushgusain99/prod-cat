      ...
      <Table stickyHeader aria-label="sticky table">
        ...
        <TableBody>
          {filteredUsers.map((user, index) => (
            ...
            >
              <TableCell sx={{ color: 'white', borderRight: '1px solid black' }}>
              ...
              <TableCell sx={{ color: 'white', borderRight: '1px solid black' }}>
                {editingUser === user._id ? (
                  ...
                  >
                    <option value="user" style={{ backgroundColor: 'black' }}>User</option>
              ...
              <TableCell align="center" sx={{ color: 'white', borderRight: '1px solid black' }}>
                {editingUser === user._id ? (
                  ...
                  <IconButton onClick={() => handleEdit(user)} color="inherit">
                    <EditIcon />
                  </IconButton>
                )}
                <IconButton
